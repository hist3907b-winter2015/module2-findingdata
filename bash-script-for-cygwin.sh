...
# getting this to work in cygwin required changing line endings from \r to \n; making sure jq.exe was in the c:\cygwin\bin directory, making sure that curl was installed via the cygwin installer in the first place, and inserting the comma in line 24.
